...
const link =
  "flex items-center md:justify-start justify-center md:gap-3 gap-0 px-3 py-2 rounded-lg hover:bg-ytbg-hover text-yt transition-colors";
      ...
      <nav className="flex-1 p-3 space-y-4 flex flex-col">
        ...
        <div className="space-y-1">
          ...
          <NavLink to="/skills" className={({ isActive }) => `${link} ${isActive ? active : ""}`}>
            <Brain className="size-5" /> <span className="hidden md:inline">Skills</span>
          </NavLink>
